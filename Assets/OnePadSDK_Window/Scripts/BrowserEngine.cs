...
#if UNITY_EDITOR_64
         string PluginServerPath = Path.Combine(Application.dataPath,@"OnePadSDK_Window\PluginServer\x64");
#else
#if UNITY_EDITOR_32
            string PluginServerPath = Application.dataPath + @"\OnePadSDK_Window\PluginServer\x86";
#else
        //HACK
